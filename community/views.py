...
from viewsets.classes import CreateUpdateDestroyDS, CreateRetrieveUpdateDestroyDS
from viewsets.permissions import IsMemberGroup, IsAuthorEntry, IsAuthorCommentEntry
from .models import Groups, EntryGroup, CommentEntryGroup
...
class CommentEntryGroupView(CreateUpdateDestroyDS):
    """Редактирование комментариев к записи"""
    permission_classes = [permissions.IsAuthenticatedOrReadOnly, IsMemberGroup]
