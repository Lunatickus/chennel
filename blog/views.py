...
from viewsets.permissions import IsAuthorComment
...
class PostFilter(rest_filters.FilterSet):
    """Фильтр статей"""
    category = CharFilter(field_name='category__name', lookup_expr='inconteins')
    tag = CharFilter(field_name='tag_name', lookup_expr='inconteins')
...
class CreatePostView(generics.CreateAPIView):
    """Добавление статьи пользоватилем"""
...
class CommentsView(generics.CreateAPIView, generics.UpdateAPIView):
    """CRUD comment"""
